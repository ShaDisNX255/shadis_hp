...
<tileset version="1.8" tiledversion="1.8.5" name="Toy Robo" tilewidth="80" tileheight="72" tilecount="138" columns="6">
 ...
 <tile id="68">
  <objectgroup draworder="index" id="2">
   <object id="1" x="40" y="0">
    <polygon points="0,16 32,32 16,40 -16,24"/>
   </object>
  </objectgroup>
 </tile>
 <tile id="71">
  <objectgroup draworder="index" id="2">
   <object id="1" x="40" y="18">
    <polygon points="0,-2 32,14 16,22 -16,6"/>
   </object>
  </objectgroup>
 </tile>
 <tile id="85" type="Stairs">
  <properties>
   <property name="Direction" value="Up Right"/>
  </properties>
 </tile>
 <tile id="86" type="Stairs">
  <properties>
   <property name="Direction" value="Up Right"/>
  </properties>
 </tile>
 <tile id="92">
  <animation>
   ...
   <frame tileid="109" duration="180"/>
   <frame tileid="110" duration="180"/>
   <frame tileid="114" duration="180"/>
  </animation>
 </tile>
 <tile id="95">
  <animation>
